...
public class GpsServices extends Service implements LocationListener, GpsStatus.Listener {
    ...
    double currentLon = 0; //latitude

    double currentLat = 0;//longitude
    ...
    PendingIntent contentIntent;// up top content intent showing app in the scroll down notification
    ...
    public void onLocationChanged(Location location) {
        ...
        if (data.isRunning()) {
            ...
            if (data.isFirstTime()) {//if the user is running for the first time
            ...
            // distance= lastlocation +current location
            ...
            if (location.hasSpeed()) {
                ...
                if (location.getSpeed() == 0) {
                    ...
                    //call async task
                    //if the user has speed put it equals to zero
                    //then we call sleep method called sleep
                    //which will wait till the user start moving
    ...
    public void updateNotification(boolean asData) {
        ...
        Notification.Builder builder = new Notification.Builder(getBaseContext())//gets the context of this page

                .setContentTitle(getString(R.string.running))//put string from the string.xml
        ...
        if (asData) {
            ...
            //gets the maxspeed and distance in the and put it in the format of the string notification
        ...
        protected String doInBackground(Void... unused) {
            ...
            try {
                ...
                while (data.getCurSpeed() == 0) {
                    //if the user has speed and it equals to zero

                    Thread.sleep(1000);
                    //sleep and add to timeer till current speed greater than 0
